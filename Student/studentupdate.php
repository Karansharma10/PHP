		...
		<div class="login-form">
			<div class="sign-in-htm">
				<div class="group">
					...
					<input id="user" type="text" value="<?php echo $row['s_name']?>" class="input" name="s_name" placeholder="NAME">
				</div>
				<div class="group">
					<label for="user" class="label">Father Name</label><br>
					<input id="user" type="text" value="<?php echo $row['s_fname']?>"class="input" name="s_fname" placeholder="FATHER NAME">
				</div>
				<div class="group">
					<label for="user" class="label">Registration no.</label><br>
					<input id="user" type="text" value="<?php echo $row['s_registration']?>"class="input" name="s_registration" placeholder="REGISTRATION NO">
				</div>
				<div class="group">
					<label for="user" class="label">Email</label><br>
					<input id="user" type="text" value="<?php echo $row['s_email']?>" class="input" name="s_email" placeholder="EMAIL">
				</div>
				<div class="group">
					<label for="user" class="label">Contact no</label><br>
					<input id="user" type="tel" value="<?php echo $row['s_phone']?>" class="input" name="s_phone" placeholder=" ENTER CONTACT NO" >
				</div>
				<div class="group">
					<label for="user" class="label">Password</label><br>
					<input id="user" type="password" value="<?php echo $row['s_password']?>" class="input" data-type="password" name="s_password" placeholder="PASSWORD">
				</div>
				<div class="group">
					<label for="user" class="label">Confirm Password</label><br>
					<input id="user" type="password" value="<?php echo $row['s_cpassword']?>" class="input" data-type="password" name="s_cpassword" placeholder="CONFIRM PASSWORD">
				</div>
				<div class="group">
					<label for="user" class="label">Username</label><br>
					<input id="user" type="text" value="<?php echo $row['s_username']?>" class="input" data-type="password" name="s_username" placeholder="ENTER USERNAME">
				</div>
				<!-- <div class="group">
				...
				<div class="group">
					...
					<input id="user" type="Rollno" value="<?php echo $row['s_rollno']?>" class="input" data-type="password" name="s_rollno" placeholder="ROLL NO">
				</div>

				<div class="group">
					<label for="user" class="label">Date of birth</label>
					<input type="date" id="user" name="s_dob" value="<?php echo $row['s_dob']?>" class="input" placeholder="DATE OF BIRTH">
				</div>


				<div class="group">
					<label for="user" class="label">Select Class</label>
                     <select id="user" name="s_class" type="text" value="<?php echo $row['s_class']?>" class="input" value="Select Class">
        ...
        ?> 
				...
				<div class="group">
					<label for="user" class="label">Select Batch</label>
                     <select id="user" type="text" name="s_batch" value="<?php echo $row['s_batch']?>" class="input" value="Select Batch">
				...
				<div class="group">
					<label for="user" class="label">Select section</label>
                     <select id="user" name="s_section" value="<?php echo $row['s_section']?>" type="text" class="input" value="Select section">
...
<br>
	<br>			
				...
				<div class="group">
					...
					<input  type="radio" id="male" name="s_gender" value="male" <?php echo ($row['s_gender'] == 'male') ? 'checked' : ''; ?>>
  <label value="male" id="male">Male</label>
  <input type="radio" id="female" name="s_gender" value="female" <?php echo ($row['s_gender'] == 'female') ? 'checked' : ''; ?> >
  <label value="female">Female</label>
				...
				<div class="hr"></div>
				<div class="group">
					<button class="but" name="submit" onclick="return Validate()">Update</button>
				</div>
