...
if (isset($_POST['submit'])) {
    $t_name = $_POST['t_name'];
     $t_fname =     $_POST['t_fname'];
        ...
        $t_cpassword =    md5($_POST['t_cpassword']) ;
  ...
  // $sql="INSERT INTO  teacherdata(image) VALUES
  //  ('$image')";
		...
		<div class="login-form">
			<div class="sign-in-htm">
				...
				<div class="group">
					...
					<input id="user" type="text" class="input" name="t_fname" placeholder="FATHER'S NAME">
				</div>
				<div class="group">
					<label for="user" class="label">Date of birth</label>
					<input type="date" id="user" name="t_dob" class="input" placeholder="DATE OF BIRTH">
				</div>
				<div class="group">
					<label for="user" class="label">Email</label><br>
					<input id="user" type="text" class="input" name="t_email" placeholder="EMAIL">
				</div>
				<div class="group">
...
<div class="group">
          ...
          <label for="user" class="label">Qualification</label><br>
				...
				<div class="group">
					...
					<input type="date" id="user" name="t_jdate" class="input" placeholder="JOINING DATE">
				</div>
				<div class="group">
					<label for="user" class="label">Username</label><br>
					<input id="user" type="text" class="input" name="t_username" placeholder="USERNAME">
				</div>
					<div class="group">
...
<br>
  ...
  <label for="other">Other</label>
				...
				<div class="hr"></div>
				<div class="group">
					<input type="submit" class="but" name="submit" value="Add Teacher" onclick="return Validate()" >
