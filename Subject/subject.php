...
$sql = "INSERT INTO subject (subjectname, subjectcode)
      ...
      <div class="sign-in-htm">
        <div class="group">
          <label for="user" class="label">Subject Name</label>
           <input type="tect" id="user" name="subjectname" class="input" placeholder="Subject Name">
                      
        </div>

        <div class="group">
          <label for="user" class="label">Subject Code</label>
<input type="tect" id="user" name="subjectcode" class="input" placeholder="Subject Code">
        ...
        <div class="group">
          <button class="but" name="submit">Add Subject</button>
        </div>
