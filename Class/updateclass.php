...
<!-- <a class="sign" href="#SignIn"><i class="fa fa-user-circle"></i>SignIn</a> -->
  ...
  <div class="login-html">
    <input id="tab-1" type="radio" name="tab" class="sign-in" checked><label for="tab-1" class="tab">Class Form</label>
      ...
      <div class="sign-in-htm">
        <div class="group">
          <label for="user" class="label">Class Name</label>
           <input type="tect" id="user" name="c_class" value="<?php echo $row['c_class']?>" class="input" placeholder="Class Name">
        ...
        <div>
          <label  class="label">Subject Code</label>
            <!-- <select name="c_subject" id="user" class="input"> -->
              <select  multiple class="chosen-select" value="<?php echo $row['c_subject[]']?>" name="c_subject[]">
